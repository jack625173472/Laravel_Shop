...
return [
    ...
    */
    ...
    'between'               => [
        ...
        'file'      => ':attribute 必須介於 :min 至 :max kilobytes 之間。 ',
    ...
    'dimensions'            => ':attribute 並非一個有效的圖片尺寸。',
    ...
    'gt'                    => [
        ...
        'file'      => ':attribute 必須大於 :value kilobytes。',
        'string'    => ':attribute 必須大於 :value 個字元。',
        'array'     => ':attribute 必須大於 :value 個元素。',
    ],
    'gte' => [
        'numeric'   => ':attribute 必須大於或等於 :value。',
        'file'      => ':attribute 必須大於或等於 :value kilobytes。',
        'string'    => ':attribute 必須大於或等於 :value 個字元。',
        'array'     => ':attribute 必須大於或等於 :value 個元素。',
    ],
    ...
    'lt'                    => [
        ...
        'file'      => ':attribute 必須小於 :value kilobytes。',
        'string'    => ':attribute 必須小於 :value 個字元。',
        'array'     => ':attribute 必須小於 :value 個元素。',
    ],
    'lte'                   => [
        'numeric'   => ':attribute 必須小於或等於 :value。',
        'file'      => ':attribute 必須小於或等於 :value kilobytes。',
    ...
    'max'                   => [
        ...
        'array'     => ':attribute 至多有 :max 個元素。',
    ],
    'mimes'                 => ':attribute 必須為 :values 的檔案。',
    'mimetypes'             => ':attribute 必須為 :values 的檔案。',
    'min'                   => [
        'numeric'   => ':attribute 不能小於 :min。',
        'file'      => ':attribute 不能小於 :min kilobytes。',
    ...
    'size'                  => [
        ...
        'file'      => ':attribute 的大小必須是 :size kilobytes。',
        'string'    => ':attribute 的大小必須是 :size 個字元。',
        'array'     => ':attribute 的大小必須是 :size 個元素。',
    ],
    'starts_with'           => ':attribute 必須以下列 :values 之一為首。',
    'string'                => ':attribute 必須是一個字串。',
    'timezone'              => ':attribute 必須是一個正確的時區值。',
    'unique'                => ':attribute 已經存在。',
    'uploaded'              => ':attribute 上傳失敗。',
    'url'                   => ':attribute 的格式錯誤。',
    'uuid'                  => ':attribute 必須是一個正確的 UUID。',
